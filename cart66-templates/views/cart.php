...
<form id='Cart66CartForm' action="" method="post">
  ...
  <tbody>
    ...
    <tr class="shipping">
      ...
      <td class="strong cart66-align-right"><?php echo Cart66Common::currency($shipping) ?></td>
    </tr>
    <?php endif; ?>
  ...
  <div id="viewCartNav">
	<div id="continueShopping">
        <?php if($cartImgPath): ?>
          <a href='<?php echo Cart66Session::get('Cart66LastPage'); ?>' class="Cart66CartContinueShopping btn secondary nice-button" >Continue Shopping</a>
        <?php else: ?>
          <a href='<?php echo Cart66Session::get('Cart66LastPage'); ?>' class="Cart66ButtonSecondary Cart66CartContinueShopping nice-button" title="Continue Shopping"><?php _e( 'Continue Shopping' , 'cart66' ); ?></a>
        <?php endif; ?>
	</div>
      ...
      <div id="checkoutShopping">
        ...
        ?>
        <?php if($checkoutImg): ?>
          <a id="Cart66CheckoutButton" class="btn-checkout btn big" href='<?php echo $checkoutUrl; ?>'>Checkout</a>
        <?php else: ?>
