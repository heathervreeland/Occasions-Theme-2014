 ...
 * Blog Widget 
 */
class Ootheme_Blog_Widget extends WP_Widget 
{
	/**
	 * General Setup 
	 */
	public function __construct() {
		...
		/* Widget settings. */
		$widget_ops = array(
			'classname' => 'oo_blog_widget', 
			'description' => __('A widget that displays your latest posts with image.', 'ootheme') 
		);
		...
		$control_ops = array(
			'width'		=> 300, 
			'height'	=> 350, 
			'id_base'	=> 'oo_blog_widget' 
		);

		/* Create the widget. */
		$this->WP_Widget( 'oo_blog_widget', __('Ootheme Recent Posts', 'ootheme'), $widget_ops, $control_ops );
	}
			...
			<div class="ootheme-blog-widget">
                <ul class="cf">
                    ...
                    <?php if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); ?>
						<?php  $image = oo_get_og_meta_image(); ?>
	...
	public function form( $instance ) 
	{
		...
		$defaults = array(
			'title' => __('Latest Blog Posts', 'ootheme'),
			'number' => 4
		);
