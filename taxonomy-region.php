...
<?php get_header(); ?>
<?php 
	$city = $region = get_term_by('slug', get_query_var('region'), 'region');
	if ($region->parent) {
...
?>
	...
	<?php if($posts_query->have_posts()) : ?>
		...
		<p id="breadcrumbs">
			...
			<span typeof="v:Breadcrumb"><a href="/<?php echo $state->slug; ?>" rel="v:url" property="v:title"><?php echo $state->name; ?></a></span> • 
			<span typeof="v:Breadcrumb"><span class="breadcrumb_last" property="v:title"><?php echo $region->name; ?></span></span>
		</p>
		...
		<div class="page-block vendors-archive" id="main">
			...
			<section class="post-container">
				...
				<?php
					$events = get_events_for_region($region, 4);
					if ($events->have_posts()) : 
				?>

					<div class="section-breaker">
						Events in <?php echo $region->name; ?>
					</div>
					...
					<div class="button-separator">
						<a href="/<?php echo $state->slug; ?>/<?php echo $region->slug; ?>/events" class="nice-button">View More</a>
					</div>
				...
				<div class="section-breaker">
					Venues in <?php echo $region->name; ?>
				</div>

				<?php oo_part("venues-menu"); ?>

				<div class="section-breaker">
					Services in <?php echo $region->name; ?>
				</div>
